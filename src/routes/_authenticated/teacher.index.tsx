  ...
  return (
    <div className="flex h-full w-full flex-col items-center justify-center p-8 text-center">
      ...
      <p className="mt-2 max-w-md text-muted-foreground">
        A structured teacher that explains grammar, introduces vocabulary, gives you exercises,
        and corrects your answers — just like a class at school. With voice, your teacher reads
        every lesson out loud and their mouth moves as they speak. Pick a lesson on the left or
        start a new one.
      </p>
